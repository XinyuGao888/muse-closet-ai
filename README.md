...
正式站支持邮箱魔法链接和无需邮箱的游客模式。每个账户或游客拥有独立的 D1 数据与私有图片空间；首次进入会获得 6 件演示单品，可以直接体验推荐、编辑、日历和反馈流程。补充衣物原图并配置试穿模型后，可上传真人全身照生成试穿效果图。
...
3. 编辑其中一套搭配，或进入“真人 AI 试穿”上传一张全身照并选择有原图的衣物。
