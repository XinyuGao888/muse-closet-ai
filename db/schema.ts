...
export const bodyModels = sqliteTable("body_models", {
  ...
  profileConfidence: real("profile_confidence").notNull().default(0.8),
...
export const tryonSessions = sqliteTable("tryon_sessions", {
  ...
  personPhotoKey: text("person_photo_key"),
  personPhotoType: text("person_photo_type"),
...
export const styleTwinSessions = sqliteTable("style_twin_sessions", {
  id: text("id").primaryKey(),
  userId: text("user_id").notNull(),
  inspirationId: text("inspiration_id").notNull(),
  bodyModelId: text("body_model_id").notNull(),
  inspirationTitle: text("inspiration_title").notNull(),
  creator: text("creator").notNull(),
  occasion: text("occasion").notNull(),
  styleTags: text("style_tags").notNull().default("[]"),
  itemIds: text("item_ids").notNull().default("[]"),
  ...
  bodyNote: text("body_note").notNull().default(""),
